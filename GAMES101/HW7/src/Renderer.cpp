...
// The main render function. This where we iterate over all pixels in the image, n  
// generate primary rays and cast these rays into the scene. The content of the
// framebuffer is saved to a file.
void Renderer::Render(const Scene& scene, bool multiprocess)
{
    ...
    FILE* fp;
    auto error_n = fopen_s(&fp, "binary.ppm", "wb");
